// api/room.js
//
// Minimal serverless proxy for Alien Armada's room state, backed by a
// Redis store (Upstash, via a Vercel Storage/Marketplace integration).
//
// This replaces a direct-from-the-browser setup against the public,
// unauthenticated kvdb.io service (unreliable, and not something to trust
// game state to). Now:
...
const ALLOWED_KEYS = new Set(['players', 'meta', 'boards', 'ready']);
